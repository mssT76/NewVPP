...
namespace NewVPP.Areas.Admin.Controllers
{
    ...
    public class AdminCustomerController : Controller
    {
        ...
        public AdminCustomerController(NewWebContext context)
        {
            _context = context;
        }
        ...
        {
            var newWebContext = _context.Customers.Include(c => c.Location);
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FullName,Phone,Email,Birthday,Password,Address,LocationId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FullName,Phone,Email,Birthday,Password,Address,LocationId")] Customer customer)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NewWebContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
