...
namespace NewVPP.Helpper
{
    public static class Utilities
    {
        ...
        public static string ToTitleCase(string str) //chuyen doi chu caiviet hoa
        {
            string result = str;
        ...
        public static bool IsInteger(string str) // kiem tra so nguyen
        {
        ...
        public static string SEOUrl(string url) // chuyen doi ki tu khong hop le, thay the khoang trang = -
        {
            url = url.ToLower();
